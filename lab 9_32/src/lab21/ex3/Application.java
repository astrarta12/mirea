...
public class Application {
    ...
    private lab21.ex3.AbstractDocumentFactory documentFactory;
    private lab21.ex3.Document document;
    ...
    private void chooseDocumentFactory(String type) {
        this.documentFactory = lab21.ex3.DocumentFactoryProvider.getFactory(type);
    }
